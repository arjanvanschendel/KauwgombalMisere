...
public final class ObjectGenerator {
	...
	public static Player genPlayer(ArrayList<String> args) {
		Point pos = new Point(Float.parseFloat(args.get(0)), Float.parseFloat(args.get(1)));
	...
	public static Wall genWall(ArrayList<String> para) {
		Point pos = new Point(Float.parseFloat(para.get(0)), Float.parseFloat(para.get(1)));
		Wall res = new Wall(pos, Float.parseFloat(para.get(2)),
				Float.parseFloat(para.get(3)), new Color(Float.parseFloat(para.get(4)),
						Float.parseFloat(para.get(5)), Float.parseFloat(para.get(6))));
		return res;
	}
